...
/******/ 	var hotCurrentHash = "49102112264e155715af"; // eslint-disable-line no-unused-vars
...
/******/ 	return hotCreateRequire("./src/2.js")(__webpack_require__.s = "./src/2.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("\n\nvar _ = __webpack_require__(/*! ./1.js */ \"./src/1.js\");\n\nvar _2 = _interopRequireDefault(_);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n// 第一个坑点  bind绑定\nvar mt = new _2.default();\nchange.onkeydown = mt.change.bind(mt); //不加绑定事件bind，this指input，加bindthis指Mt类\nfor (var i = 0; i < radioArr.length; i++) {\n    radioArr[i].onchange = mt.radioChange.bind(mt);\n}\n\n//# sourceURL=webpack:///./src/2.js?");
